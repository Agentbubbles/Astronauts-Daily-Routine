...
function draw() {
  ...
  textSize(20);
  fill("white");
  text("Instructions:",20, 35); textSize(15); 
  text("Up Arrow = Brushing",20, 55); 
  text("Down Arrow = Gymming",20, 70); 
  text("Left Arrow = Bathing",20, 85); 
  text("Right Arrow = Eating",20, 100); text("m key = Moving",20, 115);
  
  //Make Astronaut bounce off edges
    ...
    if(keyDown("DOWN_ARROW")){ 
      ...
      if(keyDown("RIGHT_ARROW")){ 
        ...
        if(keyDown("LEFT_ARROW")){ 
          ...
          astronaut.x = 300; 
          astronaut.velocityX = 00; 
          astronaut.velocityY = 00; }
